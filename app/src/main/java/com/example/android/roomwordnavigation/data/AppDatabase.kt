...
@Database(
    entities = [CharacterEntity::class, Organisation::class, OrganisationMembership::class, Template::class, Statistic::class, CharacterStatValue::class],
    version = 1
)
                    ...
                    override fun onCreate(db: SupportSQLiteDatabase) {
                        ...
                        Executors.newSingleThreadScheduledExecutor().execute {
                            ...
                            val charId = 1L
                                characters.insert(
                                    CharacterEntity(
                                        "Bob", "Looks like a bob", id = charId, template = templateId
                                    )
                                )
