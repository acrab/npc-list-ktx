...
class AddCharacterToOrganisationFragment :Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        organisationDetailsViewModel = activity?.run { ViewModelProviders.of(this, OrganisationDetailsViewModel.Factory(application,args.organisationId)).get(OrganisationDetailsViewModel::class.java)} ?: throw Exception("Invalid Activity")
        ...
        binding.fab.setOnClickListener{
            it.findNavController().navigate(AddCharacterToOrganisationFragmentDirections.actionAddCharacterToOrganisationFragmentToAddCharacterFragment())
        }
        return binding.root
    }
}